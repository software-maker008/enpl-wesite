...
export default function SoftwareAutomationCTA() {
  return (
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="mb-12">
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Our expert team is ready to help you implement cutting-edge software solutions and automation 
              systems that will revolutionize your business operations and drive unprecedented growth.
            </p>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-white/20">
            <p className="text-gray-400 text-sm">
              Join hundreds of businesses that have already transformed their operations with our software and automation solutions.
            </p>
          </div>
        </div>
      </div>
