...
export default function AccessControlsCTA() {
  return (
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="mb-3">
            <h3 className="text-sm md:text-base font-medium text-yellow-400 mb-1 tracking-wider uppercase">
              Ready to Control Access to Your Premises?
            </h3>
          ...
          <div className="mb-4">
            <p className="text-sm md:text-base text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Our expert team is ready to help you implement cutting-edge access control solutions that will 
              revolutionize your security infrastructure and provide complete control over who enters your premises.
            </p>
          </div>
          ...
          <div className="mt-6 pt-4 border-t border-white/20">
            <p className="text-gray-400 text-xs md:text-sm">
              Join hundreds of businesses that have already secured their access control with our solutions.
            </p>
          </div>
        </div>
      </div>
