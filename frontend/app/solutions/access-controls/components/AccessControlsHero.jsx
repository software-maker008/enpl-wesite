...
export default function AccessControlsHero() {
      ...
      <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
        <div className={`transform transition-all duration-1000 ease-out ${
          ...
          <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-4xl mx-auto leading-relaxed">
            Secure your premises with intelligent access control systems. From biometric authentication to 
            smart card solutions, we provide comprehensive security that protects your assets and personnel.
          </p>
          ...
          {/* Access Control Capabilities Preview */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16">
            {[
              { icon: '🔐', label: 'Biometric Auth', color: 'from-blue-400 to-blue-600' },
              { icon: '🚪', label: 'Smart Locks', color: 'from-purple-400 to-purple-600' },
              { icon: '👤', label: 'Visitor Management', color: 'from-indigo-400 to-indigo-600' },
              { icon: '📱', label: 'Mobile Access', color: 'from-cyan-400 to-cyan-600' }
