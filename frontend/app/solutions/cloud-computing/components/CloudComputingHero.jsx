...
export default function CloudComputingHero() {
  ...
  return (
    ...
    >
      ...
      {/* Floating Cloud Computing Icons */}
      ...
      <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
        <div className={`transform transition-all duration-1000 ease-out ${
          ...
          <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-4xl mx-auto leading-relaxed">
            Transform your business with scalable cloud computing solutions. From infrastructure as a service 
            to platform solutions, we deliver the computing power and flexibility your business needs to grow.
          </p>
          ...
          {/* Cloud Computing Capabilities Preview */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16">
            {[
              { icon: '☁️', label: 'Cloud Infrastructure', color: 'from-blue-400 to-blue-600' },
              { icon: '💻', label: 'Virtual Machines', color: 'from-purple-400 to-purple-600' },
              { icon: '🚀', label: 'Auto Scaling', color: 'from-indigo-400 to-indigo-600' },
              { icon: '🔒', label: 'Security & Compliance', color: 'from-cyan-400 to-cyan-600' }
